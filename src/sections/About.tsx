...
const values = [
  {
    title: 'Fiabilité',
    description: 'Un service de qualité constant et une expertise reconnue.',
  },
  {
    title: 'Réactivité',
    description: 'Une équipe toujours disponible pour vous aider rapidement.',
  },
  {
  ...
  {
    title: 'Intégrité',
    description: 'Une relation transparente et honnête avec nos clients.',
  },
];
        ...
        >
          {stats.map((stat) => (
            <StaggerItem key={stat.label}>
              <motion.div
                className="text-center p-6 rounded-2xl bg-charcoal-900/50 border border-white/5"
          ...
          <div>
            ...
            <SectionReveal delay={0.2}>
              <p className="text-lg text-white/60 mb-6 leading-relaxed">
                Nous offrons un service de qualité supérieure adapté à vos besoins. 
                Notre équipe d'experts s'engage à vous fournir les meilleures solutions 
                pour la croissance et le succès de votre activité.
              </p>
            </SectionReveal>

            <SectionReveal delay={0.3}>
              <p className="text-white/60 mb-8 leading-relaxed">
                Avec plus de 50 clients satisfaits à travers le monde, nous mettons 
                notre expertise au service de votre réussite, 24h/24 et 7j/7.
              </p>
            </SectionReveal>
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {certifications.map((cert) => (
                    <span
                      key={cert}
                      className="flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 text-emerald-400 text-sm font-medium"
                    >
            ...
            <SectionReveal delay={0.5}>
              <motion.a
                href="/about"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold hover:shadow-glow transition-all duration-300"
